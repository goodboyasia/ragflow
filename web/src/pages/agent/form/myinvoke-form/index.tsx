...
import { initialMyInvokeValues } from '../../constant';
...
const outputList = buildOutputList(initialMyInvokeValues.outputs);

function MyInvokeForm({ node }: INextOperatorForm) {
  const { t } = useTranslation();
  const defaultValues = useFormValues(initialMyInvokeValues, node);
...
export default memo(MyInvokeForm);
